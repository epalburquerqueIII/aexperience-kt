...
import com.epalburquerqueiii.aexperience.Data.Adapter.HorarioAdapter
...
class HorariosFragment : Fragment() {
    ...
    private lateinit var mAdapter: HorarioAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        bt_new.setOnClickListener{
            var intent = Intent(activity, HorarioActivity::class.java)
            var registro = Horario(0,0,"","","",0)
    ...
    fun setupViewModelAndObserve() {
        ...
        val registrosObserver = Observer<ArrayList<Horario>> {

            mAdapter = HorarioAdapter(it, activity!!)
            ...
            mAdapter.setOnItemClickListener(object : HorarioAdapter.OnItemClickListener {
                override fun onItemClick(registro: Horario) {
