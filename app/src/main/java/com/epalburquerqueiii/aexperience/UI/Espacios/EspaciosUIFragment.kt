...
class EspaciosUIFragment : Fragment() {

    private lateinit var viewModel: EspaciosUIViewModel
    ...
    fun setupViewModelAndObserve() {
        ...
        viewModel = ViewModelProvider(this).get(EspaciosUIViewModel::class.java)
