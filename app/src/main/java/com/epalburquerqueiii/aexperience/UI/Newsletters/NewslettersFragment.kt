...
import com.epalburquerqueiii.aexperience.Data.Adapter.NewslettersAdapter
import com.epalburquerqueiii.aexperience.Data.Model.Newsletter

import com.epalburquerqueiii.aexperience.R
import kotlinx.android.synthetic.main.list_fragment.*

class NewslettersFragment : Fragment() {


    private lateinit var viewModel: NewslettersViewModel

    private lateinit var linearLayoutManager: LinearLayoutManager
    private lateinit var mAdapter: NewslettersAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        bt_new.setOnClickListener{
            var intent = Intent(activity, NewsletterActivity::class.java)
            var registro = Newsletter(0,"",0)
    ...
    fun setupViewModelAndObserve() {
        ...
        val registrosObserver = Observer<ArrayList<Newsletter>> {

            mAdapter = NewslettersAdapter(it, activity!!)
            ...
            mAdapter.setOnItemClickListener(object : NewslettersAdapter.OnItemClickListener {
                override fun onItemClick(registro: Newsletter) {
